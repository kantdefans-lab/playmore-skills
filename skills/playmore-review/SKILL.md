...
After reviewing all papers, generate a comprehensive global synthesis comment:
...
输出格式：
6-8段的综合分析，每段3-4句话。
涵盖上述所有维度，形成一个完整的领域认知。
```

Output: **整体睿评思考** (6-8 paragraphs, comprehensive analysis)
